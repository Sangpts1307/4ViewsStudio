        ...
        <div class="col-md-12 content">
            <div class="row mb-3">
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control" name="name" id="name" placeholder="Tên danh mục" required>
                </div>
                <div class="col-md-6 mb-2">
                    <label for="">Giá thành</label>
                    <input type="number" class="form-control" name="price" id="price" placeholder="Giá thành" required>
                </div>
            </div>    
        </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 mb-2 d-flex">
                    ...
                    <button type="button" class="btn btn-primary" id="btnReset">
                        <i class="fa-solid fa-pen-to-square"></i>Cập nhật</button>
                </div>
            </div>
        </div>
            ...
            @foreach($expenses as $item)
                <tr>
                    ...
                    <td>
                        ...
                        <form method="POST" action="{{ url('/admin/expense/delete/'. $item->id) }}" style="display:inline-block;">
                            @csrf
                            @method('DELETE')
            ...
            btn.addEventListener('click', function () {
                ...
                fetch(`/admin/expense/edit/${id}`)
                    ...
                    .then(data => {
                        ...
                        saveButton.innerHTML = `<i class="fa-solid fa-pen-to-square"></i> Cập nhật`;
